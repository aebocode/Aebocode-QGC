...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#ffffff", "#0d191d", "#264653")
    ...
    DECLARE_QGC_COLOR(textFieldText,        "#808080", "#000000", "#000000", "#ffffff")
    ...
    DECLARE_QGC_COLOR(missionItemEditor,    "#585858", "#dbfef8", "#585858", "#f47c20")
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#585858", "#f47c20")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#ffffff", "#ffffff", "#0d191d", "#264653")
